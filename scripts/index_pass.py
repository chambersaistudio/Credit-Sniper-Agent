...
Stage 1 validation: run the INDEX PASS ONLY against a real report.
    ...
    DATABASE_URL=... python scripts/index_pass.py --report <report_id> --expect 15

    # against a local PDF, no database involvement
    python scripts/index_pass.py --pdf experian.pdf --expect 15
...
def _print_gate(quality, expected: int | None) -> None:
    ...
    if quality.ok:
        ...
        print("    python scripts/index_pass.py ... --model gpt-5.6-terra")
